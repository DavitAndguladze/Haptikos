...
function _activateSpotify(token) {
  _spotifyToken = token;
...
if (spotifyBtn) {
  spotifyBtn.addEventListener('click', async () => {
    ...
    // Use OAuth PKCE — redirect to Spotify login.
    // Requires http://localhost:3000/ registered as redirect URI in Spotify app.
